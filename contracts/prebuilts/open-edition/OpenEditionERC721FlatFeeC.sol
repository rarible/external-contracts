...
import "./OpenEditionERC721FlatFee.sol";
...
/**
 * @title OpenEditionERC721FlatFeeC
 * @author rarible
 * @notice Open Edition ERC721 with Flat Fee and Creator Token Standard (ERC721-C) support.
 */
contract OpenEditionERC721FlatFeeC is
    ...
    AutomaticValidatorTransferApproval
{
    ...
    function contractType() external pure returns (bytes32) {
        return bytes32("OpenEditionERC721FlatFeeC");
    }
    ...
    function isApprovedForAll(address owner_, address operator) public view virtual override(ERC721AUpgradeable, IERC721AUpgradeable) returns (bool) {
