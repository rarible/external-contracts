...
/**
 * @title OpenEditionERC721C
 * @author rarible
 * @notice Open Edition ERC721 with Creator Token Standard (ERC721-C) support.
 */
contract OpenEditionERC721C is
    OpenEditionERC721,
    CreatorTokenBase,
    AutomaticValidatorTransferApproval
{
    ...
    function contractType() external pure returns (bytes32) {
        return bytes32("OpenEditionERC721C");
    }
