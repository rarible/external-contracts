...
abstract contract AutomaticValidatorTransferApproval is OwnablePermissions {
    ...
    /**
     * @dev Initializes auto-approval to true. Call in your initialize() function.
     */
    function _initializeAutoApproval() internal {
        autoApproveTransfersFromValidator = true;
        emit AutomaticApprovalOfTransferValidatorSet(true);
    }
